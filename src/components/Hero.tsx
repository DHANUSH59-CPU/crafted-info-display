        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-wrap gap-3">
              {skills.map((skill) => (
                <Badge 
                  key={skill} 
                  variant="secondary" 
                  className="px-4 py-2 text-sm bg-secondary/50 text-muted-foreground hover:bg-secondary/80 transition-colors"
                >
                  {skill}
                </Badge>
              ))}
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              ...
              {/* Decorative elements */}
              <div className="absolute -top-4 -right-4 w-20 h-20 border-2 border-accent rotate-45 opacity-20"></div>
              <div className="absolute -bottom-4 -left-4 w-16 h-16 border-2 border-accent rotate-12 opacity-20"></div>
            </div>
          </div>
        </div>
      </div>
